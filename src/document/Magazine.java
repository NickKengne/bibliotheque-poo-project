        ...
        do {
            ...
            switch (choix) {
                ...
                case "1":
                    ...
                    historique.add(new Historique(new Date(), "Document", "Modification", getId(),
                            "Titre de " + ancienTitre + " par " + getTitre()));
                ...
                case "2":
                    ...
                    System.out.println("\t Modification avec succees.");
                    historique.add(new Historique(new Date(), "Document", "Modification", getId(),
                            "Localisation de " + loc + " par " + getLocalisation()));
                    b.pause(1000);
                    break;
                case "3":
                    ...
                    sc.nextLine();
                    historique.add(new Historique(new Date(), "Document", "Modification", getId(),
                            "Nb exemplaires de " + nb + " a " + getNbExemplaires() + " exemplaires en totale"));
                    System.out.println("\t Modification avec succees.");
                    b.pause(1000);
                    break;
                case "4":
                    ...
                    sc.nextLine();
                    historique.add(new Historique(new Date(), "Document", "Modification", getId(),
                            "frequence de " + freq + " par " + getFrequence()));
                    System.out.println("\t Modification avec succees.");
                    b.pause(1000);
                    break;
                default:
