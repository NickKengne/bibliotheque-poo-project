...
//        recherche document et afficher ca liste pret
    ...
    public void init(){
        ...
        //System.out.println(listAdherent);
...
//        AJOUT AUTOMATIQUE DE 5 ADHERENT
        Adherent a1 = new Adherent(1, "nick", "dibrilain", "Douala,cameroun", "Etudiant", 2, 7);
        Adherent a2 = new Adherent(2, "lamba", "Saurelle", "Douala,cameroun", "Visiteur", 1, 7);
        Adherent a3 = new Adherent(3, "lagauche", "christian", "Douala, cameroun", "Enseignant", 4, 21);
        Adherent a4 = new Adherent(4, "Ryan", "Joan", "Douala", "Etudiant", 2, 7);
        listAdherent.add(a1);
        listAdherent.add(a2);
        listAdherent.add(a3);
        listAdherent.add(a4);
...
//        AJOUT DE PRETS EN RETARD D'ARTICLE 1 AU 5EME ADHERENT
        ...
        a4.setNbPret(1);
        a4.setNbPretTotale(3);
        nombreDePretTotale++;
        d1.setNbPretTotale(1);
//        ON INITIALISE LE 2EME ADHERENT RETARDATAIRE PAR DEFAUT
        a2.setRetard(true);
        a2.setNbPretTotale(1);
